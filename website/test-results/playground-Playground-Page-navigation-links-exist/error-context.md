...
- Name: playground.spec.ts >> Playground Page >> navigation links exist
- Location: tests/playground.spec.ts:68:7
...
Locator: locator('a:has-text("GitHub")')
Expected: visible
Error: strict mode violation: locator('a:has-text("GitHub")') resolved to 2 elements:
    1) <a target="_blank" rel="noopener noreferrer" class="hover:text-foreground transition" href="https://github.com/MTconnect-BR/APIs">GitHub</a> aka getByRole('navigation').getByRole('link', { name: 'GitHub' })
    2) <a class="hover:text-foreground transition" href="https://github.com/MTconnect-BR/APIs">GitHub</a> aka locator('footer').getByRole('link', { name: 'GitHub' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('a:has-text("GitHub")')
